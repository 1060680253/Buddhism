...
public class FriendsFragment extends BaseRecycleFragment<FriendssAdapter,JsonList<CountLog>,CountLog,BasePresenter> {
    ...
    @Override
    protected FriendssAdapter getAdapter() {
        return new FriendssAdapter(mRecyclerView);
    }
    ...
    protected View getHeadView() {
        View headView = mInflater.inflate(R.layout.view_header_friends,null);
        return headView;
    }
