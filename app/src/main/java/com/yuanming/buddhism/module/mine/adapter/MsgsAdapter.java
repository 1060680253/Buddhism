...
public class MsgsAdapter extends BaseRecyclerAdapter<CountLog> {

    public MsgsAdapter(RecyclerView context) {
        super(context);
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mInflater.inflate(R.layout.list_item_sys_msg, parent, false));
    }
