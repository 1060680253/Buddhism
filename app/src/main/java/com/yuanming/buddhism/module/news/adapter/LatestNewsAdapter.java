...
public class LatestNewsAdapter extends BaseRecyclerAdapter<CountLog> {

    public LatestNewsAdapter(RecyclerView context) {
        super(context);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mInflater.inflate(R.layout.list_item_latest_news, parent, false));
    }
