...
public class PageNewsAdapter extends BaseRecyclerAdapter<CountLog> {

    public PageNewsAdapter(RecyclerView context) {
        super(context);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mInflater.inflate(R.layout.list_item_page_news, parent, false));
    }
