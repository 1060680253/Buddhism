...
public class FriendssAdapter extends BaseRecyclerAdapter<CountLog> {

    public FriendssAdapter(RecyclerView context) {
        super(context);
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mInflater.inflate(R.layout.list_item_friends, parent, false));
    }
