...
public class ENSearchView extends View {
    ...
    public void setAnimationListener(AnimationEndListener listener){
    ...
    public ENSearchView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.en_search);
        int lineColor = ta.getColor(R.styleable.en_search_search_line_color, DEFAULT_LINE_COLOR);
        int lineWidth = ta.getInteger(R.styleable.en_search_search_line_width, DEFAULT_LINE_WIDTH);
        int dotSize = ta.getInteger(R.styleable.en_search_search_dot_size, DEFAULT_DOT_SIZE);
        ta.recycle();
    ...
    public void start() {
        ...
        valueAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                mCurrentState = STATE_WAIT;
                mListener.animationEnd(ENSearchView.this);
            }
        });
        valueAnim.start();
    }
